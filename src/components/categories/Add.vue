  ...
  <div class="goods-add">
    ...
    <el-tabs tab-position="left" @tab-click="clickTab" v-model="activeName">
      <el-tab-pane label="基本信息" name="first">
        ...
        <el-button type="success" plain @click="next(1,'second')">下一步</el-button>
      </el-tab-pane>
      <el-tab-pane label="商品图片" name="second">
        ...
        <el-button type="success" plain @click="next(2,'third')">下一步</el-button>
      </el-tab-pane>
      <el-tab-pane label="商品内容" name="third">
        <quill-editor v-model="addForm.goods_introduce"></quill-editor> 
        <el-button type="success" plain @click="addGood">添加</el-button>
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    success(res) {
      let { meta: { status }, data: { tmp_path: tempPath } } = res
      if (status === 200) {
        this.pics = tempPath
      }
    },
